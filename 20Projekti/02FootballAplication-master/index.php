...
if (isset($_POST['azurirajTim'])) {
    echo $index;
    if ($_SESSION['timovi'][$index]['timID'] == $_GET['timID-izmeni']) {
        $_SESSION['timovi'][$index]['nazivTima'] = $_POST['nazivTima'];
        $_SESSION['timovi'][$index]['drzava'] = $_POST['drzava'];
        $_SESSION['timovi'][$index]['godinaOsnivanja'] = $_POST['godinaOsnivanja'];
        $_SESSION['timovi'][$index]['brojTitula'] = $_POST['brojTitula'];
        // for ($i = 0; $i < count($_SESSION['timovi']); $i++) {
