        ...
        <div id="pregled">
            <table id="tabela" class="table sortable table-bordered table-hover ">
                ...
                <tbody>
                    ...
                    $timovi = $_SESSION['timovi'];
                    foreach ($timovi as $tm) :
                    ?>
                        <tr>
                            <td><?php echo $tm['timID'] ?></td>
                            <td><?php echo $tm['nazivTima'] ?></td>
                            <td><?php echo $tm['drzava'] ?></td>
                            <td><?php echo $tm['godinaOsnivanja'] ?></td>
                            <td><?php echo $tm['brojTitula'] ?></td>

                            <td>

                                <form action="" method="get">
                                    <input type="hidden" name="timID-izmeni" value="<?php echo $tm['timID'] ?>">
                            ...
                            <td>
                                <form action="" method="get">
                                    <input type="hidden" name="timID-izbrisi" value="<?php echo $tm['timID'] ?>">
